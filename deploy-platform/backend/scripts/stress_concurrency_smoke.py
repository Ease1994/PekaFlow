...
def static_checks() -> None:
    ...
    checks = [
        ...
        ("LogBatcher.java", os.path.join(root, "agent-java", "src", "com", "qxci", "agent", "LogBatcher.java")),
    ...
    with open(os.path.join(root, "agent-java", "src", "com", "qxci", "agent", "AgentMain.java"), encoding="utf-8") as f:
        am = f.read()
...
def measure_redis_stream_latency(rounds: int = 50) -> None:
    ...
    r = get_redis()
    key = f"qxci:stress:{uuid.uuid4().hex}:logs"
