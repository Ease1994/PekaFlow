...
统一的多形态发布部署平台。**产品形态是 AI Agent**；运行时按 **DeepSeek AI-Harness**（session 事件日志、agent-loop、tools 守卫管线、system-prompt 分段、compaction、Skills、MCP→tools.register、sandbox）在发布域落地。编排仍是 Stage→Job→Step。
